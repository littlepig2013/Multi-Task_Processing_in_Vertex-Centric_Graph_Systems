...
/**
  ...
  */
public class JsonPPRVertexInputFormat extends
  TextVertexInputFormat<LongWritable, PPRVertexValue, FloatWritable> {
  ...
  */
  class JsonLongDoubleFloatDoubleVertexReader extends
    ...
    @Override
    protected PPRVertexValue getValue(JSONArray jsonVertex) throws
      ...
      return new PPRVertexValue(hashValues);
    }
    ...
    @Override
    protected Vertex<LongWritable, PPRVertexValue, FloatWritable>
